...
# Labels
pTitle = "SVO - primary items"
pX = "Group"
pY = "Primary SVO score"
saveName = file.path(figures, 'svo_primary.png')
...
# Labels
pTitle = "SVO - secondary items"
pX = "Group"
pY = "Prosocial motivation score"
saveName = file.path(figures, 'svo_secondary.png')
